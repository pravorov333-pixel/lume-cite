...
const MINECRAFT_NOTE = "📌 Видео должно быть про Minecraft — канал должен быть майнкрафт-тематики, с майнкрафт-аудиторией.";
...
const VIDEO_QUICK_TEXT = `⚡ *Любое видео — ${config.freeTaskDays.quickVideo} дней*

${MINECRAFT_NOTE}

Сними и опубликуй в TikTok или YouTube любое видео с PVP или цепляющим контентом, связанным с LumeVisuals. Видео должно набрать *минимум 5000 просмотров*.

Награда: *${config.freeTaskDays.quickVideo} дней* подписки.
...
const VIDEO_REVIEW_TEXT = `⭐ *Полный обзор — ${config.freeTaskDays.reviewVideo} дней*

*TikTok:* аккаунт от 1000 подписчиков *или* видео набрало от 10 000 просмотров.
Если подписчиков от 1000 — минимум 5000 просмотров на видео. Видео можно разбить на несколько частей, но суммарно не короче 2 минут. Ссылку на наш Telegram нужно уместить в шапке профиля, а в описании под видео написать «ссылка в профиле».

*YouTube:* канал от 100 подписчиков, обзор клиента минимум на 5 минут. Ссылку укажи в комментариях и в профиле.

Награда: *${config.freeTaskDays.reviewVideo} дней* подписки.
